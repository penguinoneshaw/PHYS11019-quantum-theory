...
\usepackage{bbm}
\usepackage{cancel}
\usepackage[sorting=none,bibencoding=utf8,giveninits,uniquename=init]{biblatex}
...
\end{equation*}
This looks a little funky, but it's fine really, just look at it as a weird application of the Green's function at different times.
